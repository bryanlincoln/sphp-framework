...
function db_connect() {
    if(LOCAL){
        $connection = new mysqli(DB_LOCAL_HOST, DB_LOCAL_USER, DB_LOCAL_PASS, DB_LOCAL_DB);
    }
    else {
        $connection = new mysqli(DB_REMOTE_HOST, DB_REMOTE_USER, DB_REMOTE_PASS, DB_REMOTE_DB);
    }
